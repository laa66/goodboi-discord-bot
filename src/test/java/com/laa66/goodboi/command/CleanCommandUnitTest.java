...
class CleanCommandUnitTest {
    ...
    void shouldExecuteValidGuildId() {
        ...
        CleanCommand command = new CleanCommand(event, repository);
        ...
        verify(scheduler, times(1)).clean(player);
    ...
    void shouldExecuteInvalidGuildId() {
        ...
        assertThrows(NoSuchElementException.class, () -> new CleanCommand(event, repository).execute());
    }
