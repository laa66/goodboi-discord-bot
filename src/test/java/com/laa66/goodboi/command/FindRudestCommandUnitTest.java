...
class FindRudestCommandUnitTest {
    ...
    void shouldExecute() {
        ...
        when(userService.findRudestUsers(anyLong())).thenReturn(Flux.just(user1, user2));
        ...
        FindRudestCommand command = new FindRudestCommand(event, userService);
        ...
        verify(userService, times(1)).findRudestUsers(77L);
